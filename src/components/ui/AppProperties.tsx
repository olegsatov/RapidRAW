...
export enum Invokes {
  ...
  ComputeBwWeights = 'compute_bw_weights',
  ...
  IsFolderCataloged = 'is_folder_cataloged',
  LoadFolderFiles = 'load_folder_files',
  LoadImage = 'load_image',
  LoadMetadata = 'load_metadata',
  LoadPresets = 'load_presets',
  LoadFlimPresets = 'load_flim_presets',
  ...
  SaveDodgeBurnMask = 'save_dodge_burn_mask',
