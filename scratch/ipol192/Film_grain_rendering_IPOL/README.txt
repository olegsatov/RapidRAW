...
You can test the code using the test image in the 'input' directory. Open a terminal and navigate to the root directory of the film grain rendering code. Then type the following command in the terminal :

./bin/film_grain_rendering_main input/bateau.png bateau_out.png
